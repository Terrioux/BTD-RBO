...
{
	protected :
    long value_min;      ///< the smallest value of the interval
    long value_max;      ///< the largest value of the interval

	public :
		// constructor
    Interval_Domain (Event_Manager * evm, unsigned int num_var, long a, long b);   		///< constructs a domain defined by the values of [a,b]
...
inline int Interval_Domain::Get_Value (long real_val)
...
inline long Interval_Domain::Get_Real_Value (int num)
