/// \file 
/// \brief Definitions related to the Equal_Weighted_Sum_Global_Constraint class

#ifndef EQUAL_WEIGHTED_SUM_GLOBAL_CONSTRAINT_H
#define EQUAL_WEIGHTED_SUM_GLOBAL_CONSTRAINT_H

#include "weighted_sum_global_constraint.h"


class Equal_Weighted_Sum_Global_Constraint: public Weighted_Sum_Global_Constraint   /// This class implements the weighted sum global constraint with condition = \ingroup core
{
	protected:
...
inline Constraint * Equal_Weighted_Sum_Global_Constraint::Duplicate ()
// returns a pointer on a copy of the constraint
{
	return new Equal_Weighted_Sum_Global_Constraint (*this);
}


inline bool Equal_Weighted_Sum_Global_Constraint::Impacted_By_Last_Events (CSP * pb, timestamp ref)
...
inline string Equal_Weighted_Sum_Global_Constraint::Get_Relation ()
