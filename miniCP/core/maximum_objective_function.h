/// \file 
/// \brief Definitions related to the Maximum_Objective_Function class

#ifndef MAXIMUM_OBJECTIVE_FUNCTION_H
#define MAXIMUM_OBJECTIVE_FUNCTION_H

#include "objective_function.h"
#include "predicate_constraint.h"


class Maximum_Objective_Function: public Objective_Function       /// This class allows to represent objective functions of COP instances which are based on a maximum \ingroup core
{
	protected:
	...
	public:
		...
		Maximum_Objective_Function (Objective obj, vector<Variable *> obj_scope);  ///< constructs an objective function involving the objective obj and a maximum based on the variables of obj_scope
...
inline void Maximum_Objective_Function::Update_From_Bounds ()
