/// \file 
/// \brief Definitions related to the Not_Equal_Sum_Global_Constraint class

#ifndef NOT_EQUAL_SUM_GLOBAL_CONSTRAINT_H
#define NOT_EQUAL_SUM_GLOBAL_CONSTRAINT_H

#include "sum_global_constraint.h"


class Not_Equal_Sum_Global_Constraint: public Sum_Global_Constraint   /// This class implements the sum global constraint with condition != \ingroup core
{
	public:
...
inline Constraint * Not_Equal_Sum_Global_Constraint::Duplicate ()
// returns a pointer on a copy of the constraint
{
	return new Not_Equal_Sum_Global_Constraint (*this);
}


inline bool Not_Equal_Sum_Global_Constraint::Impacted_By_Last_Events (CSP * pb,timestamp ref)
...
inline string Not_Equal_Sum_Global_Constraint::Get_Relation ()
