/// \file 
/// \brief Definitions related to the Minimum_Objective_Function class

#ifndef MINIMUM_OBJECTIVE_FUNCTION_H
#define MINIMUM_OBJECTIVE_FUNCTION_H

#include "objective_function.h"
#include "predicate_constraint.h"

class Minimum_Objective_Function: public Objective_Function       /// This class allows to represent objective functions of COP instances which are based on a minimum \ingroup core
{
	protected:
	...
	public:
		...
		Minimum_Objective_Function (Objective obj, vector<Variable *> obj_scope);  ///< constructs an objective function involving the objective obj and a minimum based on the variables of obj_scope
...
inline void Minimum_Objective_Function::Update_From_Bounds ()
