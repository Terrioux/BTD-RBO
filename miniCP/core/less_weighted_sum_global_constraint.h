...
class Less_Weighted_Sum_Global_Constraint: public Weighted_Sum_Global_Constraint   /// This class implements the weighted sum global constraint with condition < or <= \ingroup core
{
  protected:
	...
	public:
		...
		Less_Weighted_Sum_Global_Constraint (vector<Variable *> & var, vector<int> & w, bool is_strict, int cst);				///< constructs a new constraint which involves the variable in var and whose relation compares the sum of the values of the variables in var weighted by weight from w to the constant cst with respect to < or <= if the boolean is_strict is true
...
inline bool Less_Weighted_Sum_Global_Constraint::Compare (int sum)
