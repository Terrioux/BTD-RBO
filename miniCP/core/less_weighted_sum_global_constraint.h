/// \file 
/// \brief Definitions related to the Less_Weighted_Sum_Global_Constraint class

#ifndef LESS_WEIGHTED_SUM_GLOBAL_CONSTRAINT_H
#define LESS_WEIGHTED_SUM_GLOBAL_CONSTRAINT_H

#include "weighted_sum_global_constraint.h"


class Less_Weighted_Sum_Global_Constraint: public Weighted_Sum_Global_Constraint   /// This class implements the weighted sum global constraint with condition < or <= \ingroup core
{
  protected:
	...
	public:
		...
		Less_Weighted_Sum_Global_Constraint (vector<Variable *> & var, vector<int> & w, bool is_strict, long cst);				///< constructs a new constraint which involves the variable in var and whose relation compares the sum of the values of the variables in var weighted by weight from w to the constant cst with respect to < or <= if the boolean is_strict is true
		Less_Weighted_Sum_Global_Constraint (Less_Weighted_Sum_Global_Constraint & c);	///< constructs a new constraint by copying the constraint c
...
inline Constraint * Less_Weighted_Sum_Global_Constraint::Duplicate ()
// returns a pointer on a copy of the constraint
{
	return new Less_Weighted_Sum_Global_Constraint (*this);
}


inline bool Less_Weighted_Sum_Global_Constraint::Impacted_By_Last_Events (CSP * pb, timestamp ref)
...
inline string Less_Weighted_Sum_Global_Constraint::Get_Relation ()
...
inline bool Less_Weighted_Sum_Global_Constraint::Compare (long sum)
...
inline bool Less_Weighted_Sum_Global_Constraint::Is_Strict_Inequality ()
