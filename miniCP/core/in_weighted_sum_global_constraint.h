...
class In_Weighted_Sum_Global_Constraint: public Weighted_Sum_Global_Constraint    /// This class implements the weighted sum global constraint with condition in \ingroup core
{
  protected:
	...
	public:
		...
		In_Weighted_Sum_Global_Constraint (vector<Variable *> & var, vector<int> & w, int cst1, int cst2);	///< constructs a new constraint which involves the variable in var and which checks whether the weighted sum (weighted by weight from w) of the values of the variables in var in the interval [cst1, cst2]
...
inline bool In_Weighted_Sum_Global_Constraint::Compare (int sum)
...
inline int In_Weighted_Sum_Global_Constraint::Get_Constant2 ()
